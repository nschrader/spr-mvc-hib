...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title><spring:message code="nav.organization.edit"/></title>
  ...
  <body>
	...
	<h1><spring:message code="nav.organization.edit"/></h1>
	<p><spring:message code="eof.description"/></p>
	<p>${message}</p>
	<form:form method="post" commandName="organization" action="${pageContext.request.contextPath}/organization/edit/${organization.id}.html" onSubmit="if (this.name.value == '') {return false;}">
	  <table class="table">
	    <tbody>
	      <tr>
		...
		<td><form:input path="name" /></td>
	      ...
	      <tr>
		<td>
		  <input type="submit" value="<spring:message code="eof.submit"/>"/>
		</td>
		<td></td>
	      </tr>
	    </tbody>
